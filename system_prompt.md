...
**Step 8 - 提交审批**
调用 `submit_for_approval` 将报销单送入审批流程。系统会根据发票合规性自动执行智能拆分，AI提供审核建议但最终由审批人决策：
- 所有发票合规 + 预算充足：AI建议通过，交由审批人最终决策，发送邮件通知审批人
- 部分合规：合规发票合并新建报销单，每张不合规发票单独新建报销单，AI提供建议供审批人参考
- 全部不合规：每张发票各新建报销单，AI建议驳回，发送邮件通知审批人
- 预算不足：全部进入人工审批，AI提示预算情况
报告拆分结果和各报销单的处理状态，包含AI审核建议。
...
12. **提交审批**：submit_for_approval(reimbursement_no) -- 送入审批流，自动执行智能拆分，AI提供审核建议（通过/驳回/谨慎审批），所有报销单均需人工审批
